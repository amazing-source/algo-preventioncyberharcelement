...
\membred{}
\membree{}
\github{https://github.com/VOTRE-USERNAME/cyberharcelement-detector}
...
\begin{itemize}
\item \textbf{DJEMATENE Dilan :} Architecture générale, développement du code C, intégration de l'API Mistral, conception des prompts IA, tests et debugging
\item \textbf{LACOMBE Ariane :} Recherches sur le cyberharcèlement, rédaction du rapport, tests utilisateur, documentation, relecture
\end{itemize}
...
Modifier le fichier \texttt{config.h} avec votre clé API Mistral :
